...
extension SingaporeData {
    ...
    func sendRelativeHumidityRequest(date: String,
        ...
        let receivedResponse = try JSONDecoder().decode(RelativeHumidity.ResponseWrapper.self,
                                                        from: response)
